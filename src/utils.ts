        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex items-center justify-between h-16 gap-8">
            ...
            <div class="flex items-center gap-4 shrink-0">
               ...
               <a href="https://cnb.cool/aioful/worker-mcp" target="_blank" class="text-zinc-400 hover:text-white transition-colors">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="relative">
                            ...
                            <button @click="showApiKey = !showApiKey" class="absolute inset-y-0 right-0 px-3 flex items-center text-zinc-500 hover:text-white transition-colors">
                                ...
                                <svg x-show="showApiKey" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="display: none;">
